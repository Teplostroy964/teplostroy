...
import plant1 from "../../images/project1.jpg";
import plant2 from "../../images/project2.jpg";
      ...
      <div className="landscape-container">
        <div className="landscape-content">
          ...
          >
            ...
            <button className="landscape-button">
          ...
          >
            ...
            />
            <div className="landscape-badge">От 800 ₽/м²</div>
          </motion.div>
        </div>
      </div>
    </section>
